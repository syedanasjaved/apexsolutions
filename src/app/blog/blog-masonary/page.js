...
const page = () => {
    return (
        <>
            ...
            <Breadcrum content='See Our Newest Article' pageTitle={'Blog Masonary'} pagename={'Blog Masonary'} />
            <div className="blog-masonary-page pt-120 mb-120">
                <div className="container">
                    <div className="row gy-5 mb-70">
                        <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div className="blog-card magnetic-item">
                                <Link href="/blog/blog-details" className="blog-img">
                                    <img src="/assets/img/inner-pages/blog-masonary-img1.jpg" alt="" />
                                </Link>
                        ...
                        <div className="col-lg-4 col-md-6 pt-25 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div className="blog-card magnetic-item">
                                <Link href="/blog/blog-details" className="blog-img">
                        ...
                        <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div className="blog-card magnetic-item">
                                <Link href="/blog/blog-details" className="blog-img">
                                    <img src="/assets/img/inner-pages/blog-masonary-img2.jpg" alt="" />
                                </Link>
                                <div className="blog-content">
                                    <div className="blog-meta">
                                        <ul>
                        ...
                        <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                            <div className="blog-card magnetic-item">
                                <Link href="/blog/blog-details" className="blog-img">
                                    <img src="/assets/img/inner-pages/blog-masonary-img3.jpg" alt="" />
                                </Link>
                                <div className="blog-content">
                                    <div className="blog-meta">
                                        <ul>
                        ...
                        <div className="col-lg-4 col-md-6 pt-25 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                            <div className="blog-card magnetic-item">
                                <Link href="/blog/blog-details" className="blog-img">
                        ...
                        <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div className="blog-card magnetic-item">
                                <Link href="/blog/blog-details" className="blog-img">
                                    <img src="/assets/img/inner-pages/blog-masonary-img4.jpg" alt="" />
                                </Link>
                                <div className="blog-content">
                                    <div className="blog-meta">
                                        <ul>
                        ...
                        <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div className="blog-card magnetic-item">
                                <Link href="/blog/blog-details" className="blog-img">
                                    <img src="/assets/img/inner-pages/blog-masonary-img5.jpg" alt="" />
                                </Link>
                                <div className="blog-content">
                                    <div className="blog-meta">
                                        <ul>
                        ...
                        <div className="col-lg-4 col-md-6 pt-25 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div className="blog-card magnetic-item">
                                <Link href="/blog/blog-details" className="blog-img">
                        ...
                        <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div className="blog-card magnetic-item">
                                <Link href="/blog/blog-details" className="blog-img">
                                    <img src="/assets/img/inner-pages/blog-masonary-img6.jpg" alt="" />
                                </Link>
                                <div className="blog-content">
                                    <div className="blog-meta">
                                        <ul>

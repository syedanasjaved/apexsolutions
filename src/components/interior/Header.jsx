...
const Header = () => {
    ...
    return (
        <>
            ...
            <header className={`header-area style-1 ${state.scrollY > 20 ? "sticky" : ""}`}>
                <div className="container-fluid d-flex flex-nowrap align-items-center justify-content-between">
                    ...
                    <div className={`main-menu ${state.isSidebarOpen ? "show-menu" : ""}`}>
                        ...
                        <div className="btn-area d-lg-none d-flex justify-content-center" onClick={toggleSidebar}>
                    ...
                    <div className="nav-right d-flex jsutify-content-end align-items-center">
                        <div className="right-sidebar-button two"  onClick={toggleRightSidebar}>

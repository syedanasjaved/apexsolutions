            ...
            <div className="footer-logo-and-contact-area">
              <div className="footer-logo-area">
                ...
                <div className="footer-content">
                  <p>
                    Welcome to Apex Surfaces Solution, where innovation meet our
                    passion in a journey that started dream.
                  </p>
                  <ul className="social-list">
                    ...
                    <li>
                      <a href="https://www.facebook.com/profile.php?id=61583354677224">
                    ...
                    <li>
                      <a href="https://www.instagram.com/apexsurfacessolution/">
                ...
                <div className="col-lg-12 order-xl-1 order-2">
                  <ul className="address-area">
                    <li className="single-address">
                      <span>Karachi</span>
                      <a href="#">
                        Suite 702, Trade Avenue, Hasrat Mohani, Karachi.
                      </a>
                    </li>
                    {/* <li className="single-address">
                        ...
                        <div className="footer-widget">
                          ...
                          <div className="menu-container">
                            <ul className="widget-list">
                              <li>
                                <Link href="/products/minerals">Minerals</Link>
                              </li>
                              <li>
                                <Link href="/products/marbles">Marbles</Link>
                              </li>
                              <li>
